...
RC VacuousTrx::update_record(Table *table, Record &old_record, std::vector<Value> value,std::vector<const char *> field_name)
{
  return table->update_record(old_record,value,field_name);
}
